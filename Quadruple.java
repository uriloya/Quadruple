...
public abstract class Quadruple<L, ML, MR, R> implements Comparable<Quadruple<L, ML, MR, R>>, Serializable {
    ...
    /**
     * <p>Obtains an immutable Quadruple of three objects inferring the generic types.</p>
     *
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>Compares the Quadruple based on the left element, followed by the middle element,
    ...
    /**
     * <p>Compares this Quadruple to another based on the three elements.</p>
     *
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>Gets the left element from this Quadruple.</p>
     *
    ...
    /**
     * <p>Gets the middle left element from this Quadruple.</p>
     *
    ...
    /**
     * <p>Gets the middle right element from this Quadruple.</p>
     *
    ...
    /**
     * <p>Gets the right element from this Quadruple.</p>
     *
    ...
    /**
     * <p>Returns a String representation of this Quadruple using the format {@code ($left,$middleLeft,$middleRight,$right)}.</p>
     *
     ...
     * element, {@code %2$s} for the middle left, {@code %3$s} for the middle right and {@code %4$s} for the right element.
